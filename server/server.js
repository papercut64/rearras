    ...
    switch (pathname) {
        case "/getServers.json": {
            readString = JSON.stringify([
                {
                    ip: "test.rearras.dev:3001", // <-- Tell browser to knock on Nginx's door!
                ...
                {
                    ip: "test.rearras.dev:3002", // <-- Tell browser to knock on Nginx's door!
                ...
                {
                    ip: "test.rearras.dev:3003", // <-- Tell browser to knock on Nginx's door!
                ...
                {
                    ip: "test.rearras.dev:3099", // <-- Tell browser to knock on Nginx's door!
