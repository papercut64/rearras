    ...
    switch (pathname) {
        case "/getServers.json": {
            readString = JSON.stringify([
                {
                    ip: "la.rearras.dev:3001", // Your raw IP + room la port
                ...
                {
                    ip: "ls.rearras.dev:3002", // Your raw IP + room ls port
                    ...
                    gameMode: "Siege Blitz"
                                ...
                                {
                    ip: "lx.rearras.dev:3003", // Your raw IP + room lx port
                    ...
                    gameMode: "Nexus"
                                ...
                                {
                    ip: "lz.rearras.dev:3099", // Your raw IP + room lz port
