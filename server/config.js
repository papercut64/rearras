module.exports = {
    ...
    host: '153.75.91.27:3000', // Game server domain. If the host is 'localhost:NUMBER', the NUMBER must be the port setting.
    ...
    servers: [ // Make sure to change the host, port and id between servers!
        {
            ...
            host: '153.75.91.27:3001', // Server host location.
        ...
        },
        {
            ...
            host: '153.75.91.27:3002', // Server host location.
            ...
            host: '153.75.91.27:3003', // Server host location.
        ...
        },
        {
            ...
            host: '153.75.91.27:3099', // Server host location.
